...
def take_keyboard(num):
    if num == 'r1':
        ...
        b2 = types.InlineKeyboardButton(text='📁Поиск секций по фильтрам📁', callback_data=Callback_data[7])
        ...
        b3 = types.InlineKeyboardButton(text='По направлениям🙋', callback_data=Callback_data[10])
